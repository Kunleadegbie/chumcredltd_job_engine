# ==========================================================
# app.py — AUTH ENTRY POINT (BEAUTIFUL LANDING + SAME AUTH)
# ==========================================================
    ...
    <style>
        ...
        .ti-hero {
            ...
            background: linear-gradient(135deg,
                rgba(53, 153, 255, 0.16),
                rgba(110, 231, 183, 0.12),
                rgba(250, 204, 21, 0.10)
            );
        }
        .ti-title { font-size: 2.1rem; font-weight: 900; margin: 0; }
        .ti-subtitle { font-size: 1.05rem; margin-top: 8px; }
        .ti-muted { color: rgba(49, 51, 63, 0.78); }
        .ti-small { font-size: 0.95rem; line-height: 1.5rem; }

        .ti-badges { margin-top: 4px; }
        .ti-badge {
        ...
        .ti-kpi { display:flex; gap:12px; flex-wrap: wrap; margin-top: 6px; }
        .ti-card {
            border: 1px solid rgba(49, 51, 63, 0.12);
            border-radius: 16px;
            padding: 14px 14px;
...
# ==========================================================
# BEAUTIFUL LANDING / STORY SECTION
# IMPORTANT: unsafe_allow_html=True or HTML will show as text
# ==========================================================
st.markdown(
    """
    <div class="ti-hero">
